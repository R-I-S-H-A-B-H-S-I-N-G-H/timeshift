export function getTimezoneIdToOffsetHr(_timezoneId) {
	const timezoneid = _timezoneId?.toUpperCase();
	const offset = timezoneidToOffsetMap[timezoneid];
	if (!offset) throw new Error(`DOES NOT SUPPORT FOR :: ${timezoneid}  timezoneid`);
	return offset;
}

export function getTimezoneIdToOffsetMin(_timezoneId) {
	return getTimezoneIdToOffsetHr(_timezoneId) * 60;
}

export function getTimezoneIdToOffsetSec(_timezoneId) {
	return getTimezoneIdToOffsetMin(_timezoneId) * 60;
}

export function getTimezoneIdToOffsetMill(_timezoneId) {
	return getTimezoneIdToOffsetSec(_timezoneId) * 1000;
}

/**
 *
 * timeZoneID to offset UTC hour map
 */
export const timezoneidToOffsetMap = {
	DST: -12,
